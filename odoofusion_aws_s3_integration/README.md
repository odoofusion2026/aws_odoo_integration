# Cloud Storage | AWS S3 Integration — Universal Offload (Odoo 17)
...
## Overview
Universal AWS S3 Storage Backend for Odoo 17. Offloads ALL binary files, images, product images, Chatter attachments, and invoice PDFs to AWS S3 automatically. Zero Odoo local disk usage.
...
- **S3 File Explorer & Live Dashboard**: Native Odoo dashboard and S3 bucket file explorer.
