{
    ...
    'summary': (
        'Universal AWS S3 Storage Backend for Odoo 18. '
        'ALL files, images, and attachments stored in S3 automatically. '
        'Zero local disk usage. Full website & eCommerce image offloading.'
    ),
    'description': """
AWS S3 Universal Storage Backend for Odoo 18
============================================

Version 18.0.2.0.0 — Full Odoo Storage Offload Architecture for Odoo 18

What This Module Does
---------------------
Makes AWS S3 the universal storage backend for ALL binary data in Odoo 18.
